      ...
      <div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          <div>
            ...
            <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Gecko Testnet Faucet</h2>
            <p className="mt-2 text-center text-sm text-gray-600">
              <a href="https://explorer-testnet.geckochain.com" target="_blank" rel="noreferrer" className="font-medium text-indigo-600 hover:text-indigo-500">
              Check it out on Gecko Testnet
              </a>
            </p>
          </div>
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button disabled={isDisabled} type="submit" className="disabled:opacity-25 group relative flex w-full justify-center rounded-md border border-transparent bg-lime-600 py-2 px-4 text-sm font-medium text-white hover:bg-lime-700 focus:outline-none focus:ring-2 focus:ring-lime-500 focus:ring-offset-2">
                Request Funds
              </button>
            </div>
          </form>
